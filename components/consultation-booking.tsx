...
export default function ConsultationBooking({ data, leadScore }: BookingProps) {
  ...
  const getRecommendedSlots = () => {
    const baseSlots = [
      ...
      { id: "3", date: "Day After", time: "11:00 AM", expert: "Anita Singh", speciality: "AI/ML", priority: "high" },
      { id: "4", date: "Day After", time: "4:00 PM", expert: "Vikram Patel", speciality: "DevOps", priority: "medium" },
      {
        id: "5",
        date: "This Weekend",
        time: "10:00 AM",
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        <div className="bg-green-50 p-8 rounded-2xl">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Consultation Booked Successfully! 🎉</h1>
          <p className="text-lg text-gray-600 mb-6">
            You'll receive a confirmation email with the meeting link and preparation materials within 5 minutes.
          </p>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Book Your Free Career Consultation</h1>
        <p className="text-lg text-gray-600">Choose a time that works for you and get personalized career guidance</p>
        {leadScore > 80 && (
            ...
            {slots.map((slot) => (
              <Card
                ...
                className={`cursor-pointer transition-all ${
                  selectedSlot === slot.id ? "border-blue-500 bg-blue-50" : "hover:border-gray-300"
                }`}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">{slot.speciality} Expert</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
                      {slot.priority === "high" && <Badge className="bg-green-100 text-green-800">Recommended</Badge>}
          ...
          <Card>
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label htmlFor="message">Specific Questions or Goals (Optional)</Label>
                  <Textarea
                    id="message"
