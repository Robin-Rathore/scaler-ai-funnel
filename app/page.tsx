...
import { ArrowRight, Brain, Target, TrendingUp, Users, Calendar, CheckCircle } from "lucide-react"
...
export default function ScalerFunnel() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case "landing":
        return <LandingSection onStartAssessment={() => setCurrentStep("assessment")} />
      case "assessment":
      ...
      case "booking":
        return <ConsultationBooking data={assessmentData} leadScore={leadScore} />
      default:
        return <LandingSection onStartAssessment={() => setCurrentStep("assessment")} />
    }
  }
        ...
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <img src="/placeholder.svg?height=32&width=120&text=Scaler" alt="Scaler" className="h-8" />
              <Badge variant="secondary">AI-Powered Career Assessment</Badge>
            </div>
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <div
                className={`flex items-center space-x-1 ${currentStep === "assessment" || currentStep === "report" || currentStep === "booking" ? "text-blue-600" : ""}`}
              >
              ...
              <div
                className={`flex items-center space-x-1 ${currentStep === "report" || currentStep === "booking" ? "text-blue-600" : ""}`}
              >
                <CheckCircle className="w-4 h-4" />
                <span>Report</span>
              </div>
              <ArrowRight className="w-4 h-4" />
              <div className={`flex items-center space-x-1 ${currentStep === "booking" ? "text-blue-600" : ""}`}>
...
function LandingSection({ onStartAssessment }: { onStartAssessment: () => void }) {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Take our AI-powered assessment and get a personalized roadmap to land your dream tech job. Used by 50,000+
        ...
        <Button size="lg" className="text-lg px-8 py-6 bg-blue-600 hover:bg-blue-700" onClick={onStartAssessment}>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mb-8">Get personalized career guidance in 3 simple steps</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Answer questions about your background, goals, and preferences</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">Receive personalized career recommendations and learning path</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">Schedule a free consultation with our career experts</p>
          </div>
        </div>
      </div>
    </div>
